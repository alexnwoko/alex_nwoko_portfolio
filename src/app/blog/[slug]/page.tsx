...
The scale of what this can do is not hypothetical. The [World Health Organization recorded in 2016](https://www.who.int/news-room/feature-stories/detail/el-ni%C3%B1o-affects-more-than-60-million-people) that the 2015–2016 El Niño was affecting more than 60 million people across eastern and southern Africa, the Horn of Africa, Latin America and the Caribbean, and the Asia-Pacific region. The health pathway alone, in WHO's account, included disease outbreaks, malnutrition, heat stress and respiratory diseases, layered on top of severe drought, flooding and temperature anomalies. The 2023–2024 cycle hit southern Africa hard enough to trigger region-wide drought emergencies, parallel emergency appeals through OCHA, WFP and FAO, and the loss of pasture and livestock that, in FAO's framing, "quickly becomes a loss of assets and wealth" in regions where livestock underpins both food security and household income.
