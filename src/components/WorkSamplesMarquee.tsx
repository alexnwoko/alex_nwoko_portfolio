...
const SAMPLES: { src: string; title: string }[] = [
  ...
  { src: '/work-samples/afg-thematic-flood-vulnerability-mapping-2023.png',  title: 'AFG Thematic Flood Vulnerability Mapping (2023)' },
  { src: '/work-samples/afg-thematic-flood-vulnerability-2018.png',          title: 'AFG Thematic Flood Vulnerability Mapping (2018)' },
  ...
  { src: '/work-samples/newcastle-social-vulnerability-extreme-temperatures.png', title: 'Newcastle Social Vulnerability to Extreme Temperatures' },
